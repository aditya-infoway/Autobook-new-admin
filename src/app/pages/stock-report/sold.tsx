...
const STATIC_SOLD_ENQUIRIES = [
  {
    id: 1,
    leadId: "Q/26-27/1320/R1",
    dmsEnquiryNo: "ENQ26001420",
  ...
  {
    id: 2,
    leadId: "Q/26-27/1321/R3",
    dmsEnquiryNo: "ENQ26001421",
  ...
  {
    id: 3,
    leadId: "Q/26-27/1322/R1",
    dmsEnquiryNo: "ENQ26001422",
...
export default function Sold() {
  ...
  const filteredData = STATIC_SOLD_ENQUIRIES.filter((item) => {
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900 md:text-2xl dark:text-white">
            Enquiry Source - Sold Report
          </h1>
          <p className="dark:text-dark-300 mt-1 text-sm text-gray-500">
            View all sold enquiry records
          </p>
        </div>

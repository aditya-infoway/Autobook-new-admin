...
const STATIC_DELIVERY_REGISTER = [
  {
    id: 1,
    model: "ACCESS 125",
    variant: "DISC RC ABS",
...
const MODEL_ANALYSIS_DATA = [
  { model: "ACCESS 125", deliveries: 65 },
  { model: "BURGMAN STREET", deliveries: 18 },
  { model: "GIXXER SF", deliveries: 12 },
];
...
export default function DeliveryRegister() {
  ...
  const handleView = (id: number) => {
    console.log(`Viewing delivery details for record ${id}`);
  };

  // Filter and Pagination Logic
  const filteredData = STATIC_DELIVERY_REGISTER.filter((item) => {
...
<div className="flex items-center gap-1.5">
  ...
  >
    <ArrowPathIcon className="h-6 w-6 text-gray-500" />
      ...
      {/* Analytics Section: Delivery Analysis */}
          ...
          <Table className="w-full min-w-[600px]">
            <THead className="dark:bg-dark-700/60 dark:border-dark-600 border-b border-gray-200 bg-gray-100">
              <Tr>
                ...
                <Th className="text-center text-[11px]">Total Delivered</Th>
              </Tr>
            </THead>

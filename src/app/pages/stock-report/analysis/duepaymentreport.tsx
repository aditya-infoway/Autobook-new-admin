...
const STATIC_DUE_PAYMENTS = [
  {
    ...
    purchaseLocation: "Main Branch",
    dueDate: "14-08-2026",
    grandTotal: "1,48,700.00",
  },
  {
    id: 2,
    date: "30-07-2026",
    ...
    purchaseLocation: "North Branch",
    dueDate: "13-08-2026",
    grandTotal: "1,01,100.00",
  },
  {
    id: 3,
    date: "29-07-2026",
    ...
    purchaseLocation: "South Branch",
    dueDate: "12-08-2026",
    grandTotal: "2,97,500.00",
  },
  {
    id: 4,
    date: "28-07-2026",
    type: "Credit",
    partyName: "PQR Tradelink",
    billNo: "B/26-27/004",
    purchaseBillNo: "PB-004",
    purchaseDate: "28-07-2026",
    purchaseLocation: "East Branch",
    dueDate: "11-08-2026",
    grandTotal: "75,000.00",
  },
  {
    id: 5,
    date: "25-07-2026",
    type: "Credit",
    partyName: "LMN Logistics",
    billNo: "B/26-27/005",
    purchaseBillNo: "PB-005",
    purchaseDate: "25-07-2026",
    purchaseLocation: "West Branch",
    dueDate: "08-08-2026",
    grandTotal: "2,10,500.00",
  },
];

// ─── MAIN COMPONENT ─────────────────────────────────────────────────────────

export default function DuePaymentReport() {
  ...
  const filteredData = STATIC_DUE_PAYMENTS.filter((item) => {
    ...
    return (
      ...
      item.purchaseLocation.toLowerCase().includes(searchLower)
    );
  });
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="dark:text-dark-300 mt-1 text-sm text-gray-500">
            View all due payments and pending bills
          </p>
        </div>
  ...
  >
    <ArrowPathIcon className="h-6 w-6 text-gray-600" />
      ...
      <div className="relative w-full max-w-md">
        ...
        <input
          type="text"
          placeholder="Search by party, bill no, or location..."
          value={search}
          onChange={(e) => {
          ...
          <Table className="w-full min-w-[1000px]">
            <THead className="dark:bg-dark-700/60 dark:border-dark-600 border-b border-gray-200 bg-gray-100">
              <Tr>
                ...
                <Th className="text-[11px]">Purchase Location</Th>
                <Th className="text-[11px]">Due Date</Th>
                <Th className="text-[11px] text-right">Grand Total</Th>
              </Tr>
            </THead>
            ...
            <TBody className="dark:divide-dark-700 divide-y divide-gray-200">
              {currentItems.map((item, index) => (
                <Tr key={item.id} className="dark:hover:bg-dark-700/40 transition-colors hover:bg-gray-50/30 align-middle">
                  ...
                  <Td className="py-3 text-[12px] text-gray-700 dark:text-gray-300">{item.purchaseLocation}</Td>
                  <Td className="py-3 text-[12px] text-gray-700 dark:text-gray-300">{item.dueDate}</Td>
                  <Td className="py-3 text-[12px] font-bold text-gray-900 dark:text-white text-right">
                    ₹{item.grandTotal}
                  </Td>
                </Tr>
              ))}

...
export default function InsuranceReport() {
  ...
  const handleView = (id: number) => {
    console.log(`Viewing insurance details for record ${id}`);
  };

  // Filter and Pagination Logic
  const filteredData = STATIC_INSURANCE.filter((item) => {
  ...
  <div className="flex items-center gap-1.5">
    ...
    >
      ...
      {/* Analytics Section: Insurance Analysis - Placed below table */}
      <div className="mt-8 space-y-3">
        {/* Insurance Analysis Title */}

...
const handleView = (field: string, id: number) => {
  ...
  const filteredData = STATIC_ENQUIRY_STATUS.filter((item) => {
    const searchLower = search.toLowerCase();
    return item.enquiryStatus.toLowerCase().includes(searchLower);
  });
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="dark:text-dark-300 mt-1 text-sm text-gray-500">
            View enquiry status wise performance
          </p>
        </div>
  ...
  >
    <ArrowPathIcon className="h-6 w-6 text-gray-600" />
      ...
      <div className="relative w-full max-w-md">
        ...
        <input
          type="text"
          placeholder="Search by enquiry status..."
          value={search}
          onChange={(e) => {
          ...
          <Table className="w-full min-w-[900px]">
            <THead className="dark:bg-dark-700/60 dark:border-dark-600 border-b border-gray-200 bg-gray-100">
              <Tr>
                ...
                <Th className="text-[11px]">Enquiry Status</Th>
                <Th className="text-[11px] text-center">Total Enq.</Th>
                <Th className="text-[11px] text-center">Pending</Th>
                <Th className="text-[11px] text-center">Alloted</Th>
                <Th className="text-[11px] text-center">Sold</Th>
                <Th className="text-[11px] text-center">Regi. Process</Th>
                <Th className="text-[11px] text-center">Lost</Th>
              </Tr>
            </THead>

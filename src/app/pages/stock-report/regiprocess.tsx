...
const STATIC_REGI_PROCESS = [
  {
    id: 1,
    leadId: "Q/26-27/1330/R1",
    dmsEnquiryNo: "ENQ26001430",
  ...
  {
    id: 2,
    leadId: "Q/26-27/1331/R3",
    dmsEnquiryNo: "ENQ26001431",
  ...
  {
    id: 3,
    leadId: "Q/26-27/1332/R1",
    dmsEnquiryNo: "ENQ26001432",
...
export default function RegiProcess() {
  ...
  const filteredData = STATIC_REGI_PROCESS.filter((item) => {
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900 md:text-2xl dark:text-white">
            Enquiry Source - Regi-process Report

          </h1>
          <p className="dark:text-dark-300 mt-1 text-sm text-gray-500">
            View all registration process enquiry records
          </p>
        </div>

...
const STATIC_LOST_ENQUIRIES = [
  {
    id: 1,
    leadId: "Q/26-27/1301/R1",
    dmsEnquiryNo: "ENQ26001401",
  ...
  {
    id: 2,
    leadId: "Q/26-27/1302/R3",
    dmsEnquiryNo: "ENQ26001402",
    dmsEnquiryDate: "04-08-2026",
  ...
  {
    id: 3,
    leadId: "Q/26-27/1303/R1",
    dmsEnquiryNo: "ENQ26001403",
    dmsEnquiryDate: "04-08-2026",
...
const [toDate, setToDate] = useState<string>("");
  ...
  const filteredData = STATIC_LOST_ENQUIRIES.filter((item) => {
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900 md:text-2xl dark:text-white">
            Enquiry Source - Lost Report
          </h1>
          <p className="dark:text-dark-300 mt-1 text-sm text-gray-500">
            View all lost enquiry records
          </p>
        </div>

...
const schemeTypeOptions = [
  { id: 1, name: "Festival Offer" },
  { id: 2, name: "Cashback Offer" },
  { id: 3, name: "Seasonal Discount" },
  { id: 4, name: "Exchange Offer" },
  { id: 5, name: "Finance Offer" },
  { id: 6, name: "Special Discount" },
];
...
export default function Scheme() {
  ...
  const filteredData = schemes.filter((item) => {
    const matchesSearch =
      ...
      item.schemeType.toLowerCase().includes(search.toLowerCase());
    const matchesModel =
  ...
  const handleOpenEditDrawer = (item: any) => {
    ...
    setFormData({
      ...
      schemeAmount: String(item.schemeAmount),
  ...
  const handleToggleStatus = (id: number) => {
    alert(`Toggle status for scheme ID: ${id}`);
  };

  const handleBulkDelete = () => {
    alert(`Delete ${selectedIds.length} selected schemes`);
  };

  const modelFilterOptions = [
    { id: "All", name: "All" },
    ...Array.from(new Set(schemes.map((c) => c.model))).map((n) => ({
      id: n,
      name: n,
    })),
  ];
              ...
              {currentItems.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Td className="py-4 text-gray-600 dark:text-gray-400">
                      ₹{item.schemeAmount.toLocaleString()}
                    </Td>
                    <Td className="py-4 text-gray-600 dark:text-gray-400">
                      {item.fromDate}
                    </Td>
              ...
              >
                <div className="bg-primary-500 flex items-center justify-between px-5 py-4">
                  <h2 className="text-lg font-semibold text-white">
                    {editId !== null ? "Edit Scheme" : "Add Scheme"}
                  </h2>
                  <Button
                ...
                <div className="grow overflow-y-auto p-5">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    {/* Row 2: Location, Scheme Type, Scheme Amount */}
                    <div>
                      <label className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">
                      ...
                      <Combobox
                        ...
                        value={locationOptions.find(
                          (opt) => opt.name === formData.location,
                        )}
                        onChange={(selected: any) => {
                          setFormData({
                            ...formData,
                    ...
                    <div>
                      ...
                      <Combobox
                        ...
                        displayField="name"
                        value={schemeTypeOptions.find(
                          (opt) => opt.name === formData.schemeType,
                        )}
                        onChange={(selected: any) => {
                          setFormData({
                            ...formData,
                            schemeType: selected?.name || "",
                          });
                        }}
                    ...
                    <div>
                      <label className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        Scheme Amount <span className="text-red-500">*</span>
                      </label>
                      <Input
                        type="number"

...
import { Button, Checkbox, Input, Select } from "@/components/ui"; // Add Select import
...
export default function Category() {
  ...
  const handleToggleStatus = (id: number) => {
    alert(`Toggle status for category ID: ${id}`);
  };

  const handleBulkDelete = () => {
    alert(`Delete ${selectedIds.length} selected categories`);
  };

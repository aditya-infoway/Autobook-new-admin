...
const STATIC_HISTORY = [
  {
    id: 101,
    createdBy: "Jaysingh",
    createdType: "SALES_EXECUTIVE",
    nextScheduledDate: "2026-08-10T10:00:00",
    callTime: "10:30 AM",
    expectedPurchaseDate: "2026-08-15T00:00:00",
    callResponse: "Connected",
    discussion: "Customer is interested in the finance option. Will call back after discussing with family.",
  ...
  },
  {
    ...
    createdBy: "Rakesh",
    createdType: "BRANCH",
    nextScheduledDate: "2026-08-05T14:00:00",
    callTime: "02:15 PM",
    expectedPurchaseDate: "2026-08-10T00:00:00",
    callResponse: "Call Back",
    discussion: "Customer requested a test drive on the weekend. Follow up on Monday.",
  ...
  },
  {
    ...
    createdBy: "Admin",
    createdType: "SALES_EXECUTIVE",
    nextScheduledDate: "2026-08-01T09:00:00",
    callTime: "11:45 AM",
    expectedPurchaseDate: "2026-07-28T00:00:00",
    callResponse: "Busy",
    discussion: "Customer was busy. Will try again in the evening.",
    createdAt: "2026-07-28T11:45:00",
  },
];
...
const FollowupHistory: React.FC = () => {
  ...
  const lead = STATIC_LEAD;
  const followups = STATIC_HISTORY;

  // Both tabs currently read from the same static data.
  // You can switch this to separate static data arrays later if needed.

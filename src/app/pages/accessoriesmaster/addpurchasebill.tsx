...
const customSelectStyles = {
  ...
  const handleBack = () => {
    navigate("/accessoriesmaster/purchaseaccessories");
  };
...
{bankDetailsModalOpen && (
  <div className="fixed inset-0 z-50 overflow-hidden">
    ...
    />
    <div className="absolute top-0 right-0 h-full w-full max-w-xl transform bg-white shadow-2xl dark:bg-gray-800">
      <div className="flex h-full flex-col">

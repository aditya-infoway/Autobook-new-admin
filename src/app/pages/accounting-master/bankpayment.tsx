...
const STATIC_BANK_PAYMENTS = [
  {
    id: 1,
    date: "31-07-2026",
    voucherNo: "BP/26-27/007",
    type: "JBP",
    bankAccount: "HDFC BANK",
    oppAccount: "Purnima P",
    amount: "5000",
    paymentType: "NEFT",
    chequeNo: "",
    chequeDate: "",
  ...
  },
  {
    id: 3,
    date: "31-07-2026",
    voucherNo: "BP/26-27/005",
    type: "JBP",
    bankAccount: "SBI BANK",
    oppAccount: "Issa Kamal",
    amount: "2000",
    paymentType: "UPI",
    chequeNo: "",
    chequeDate: "",
                  ...
                  <div className="flex h-full max-h-screen flex-col bg-white shadow-xl dark:bg-gray-800">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 md:p-6">
                      <div className="space-y-5">
                        ...
                        {/* Mode (ALWAYS visible for both Manual and Lead Cancel) */}
                        <div>
                          <label className="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">
                            Mode:
                          </label>
...
export default function BankPayment() {
  ...
  const filteredData = STATIC_BANK_PAYMENTS.filter((item) => {

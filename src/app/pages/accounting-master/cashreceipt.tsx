...
const STATIC_CASH_RECEIPTS = [
  {
    id: 1,
    date: "31-07-2026",
    voucherNo: "CR/26-27/1338",
    type: "JCR",
  ...
  },
  {
    id: 3,
    date: "31-07-2026",
    voucherNo: "CR/26-27/1336",
    type: "JCR",
    cashAccount: "CASH ACCOUNT",
    oppAccount: "Bhikaji Warpe",
    amount: "2000",
...
const STATIC_OPP_ACCOUNTS = [
  { id: 1, name: "Anupama Hinduja" },
  { id: 2, name: "Nilima Kale" },
  { id: 3, name: "Bhikaji Warpe" },
];
...
export default function CashReceipt() {
  ...
  const filteredData = STATIC_CASH_RECEIPTS.filter((item) => {
            ...
            <TBody className="dark:divide-dark-700 divide-y divide-gray-200">
              {currentItems.map((item, index) => (
                <Tr key={item.id} className="dark:hover:bg-dark-700/40 transition-colors hover:bg-gray-50/30 align-middle">
                  ...
                  <Td className="py-3 text-[12px] text-gray-700 dark:text-gray-300">{item.cashAccount}</Td>

...
const STATIC_CASH_BANK_ACCOUNTS = [
...
function AddContraDrawer({
  ...
  const [type, setType] = useState<
    "Cash Deposit" | "Cash Withdrawal" | "Bank Transfer"
  >("Cash Deposit");
                  ...
                  <div className="flex h-full max-h-screen flex-col bg-white shadow-xl dark:bg-gray-800">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 md:p-6">
                      <div className="space-y-5">
                          ...
                          <div className="flex flex-wrap gap-6">
                            <label className="flex cursor-pointer items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                              <input
                                ...
                                name="type"
                                value="Cash Deposit"
                                checked={type === "Cash Deposit"}
                                onChange={() => setType("Cash Deposit")}
                            ...
                            <label className="flex cursor-pointer items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                              <input
                                ...
                                checked={type === "Cash Withdrawal"}
                                onChange={() => setType("Cash Withdrawal")}
                                className="accent-primary-500"
                              />
                              Cash Withdrawal
                            </label>
                            <label className="flex cursor-pointer items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                              <input
                                ...
                                onChange={() => setType("Bank Transfer")}
                                className="accent-primary-500"
                              />
                              Bank Transfer
                            </label>
                        ...
                        {/* Row 2: Cash/Bank Account | Voucher No | Date */}
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                          <div>
                            ...
                            <Combobox
                              data={STATIC_CASH_BANK_ACCOUNTS}
                              displayField="name"
                              placeholder="Select"
                            />
                          </div>
...
export default function Contra() {
  ...
  const filteredData = STATIC_CONTRA.filter((item) => {
    const searchLower = search.toLowerCase();
    return (
      item.voucherNo.toLowerCase().includes(searchLower) ||
      item.cashBankAccount.toLowerCase().includes(searchLower) ||
          ...
          <Table className="w-full min-w-[1000px]">
            <THead className="dark:bg-dark-700/60 dark:border-dark-600 border-b border-gray-200 bg-gray-100">
              <Tr>
                ...
                <Th className="text-[11px]">Cash/Bank Account</Th>
